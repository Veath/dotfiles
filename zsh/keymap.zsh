...
bindkey -M menuselect "^[[105;5u" forward-char  # Ctrl+i in CSI u, configured in kitty.conf
...
bindkey -M vicmd "^[[105;5u" vi-add-eol         # Ctrl+i in CSI u, configured in kitty.conf 
bindkey -M vicmd "^[[44;5u"  edit-command-line  # Ctrl+, in CSI u, configured in kitty.conf 
...
bindkey -M viins "^[[44;5u"  edit-command-line     # Ctrl+, in CSI u, configured in kitty.conf
